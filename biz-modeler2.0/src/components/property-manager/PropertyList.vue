  ...
  <div>
    ...
    <div class="main-content">
      ...
      <el-table
        ...
        <el-table-column label="属性代码" prop="edmpCode" :width="dataIn.mode === 'edit'? '110px':'125px'" align="center"  fixed>
        </el-table-column>
        ...
        <el-table-column label="属性公式" width="200px" show-overflow-tooltip align="center"  show-overflow-tooltip prop="propertFormula">
        </el-table-column>
      ...
      <el-table v-if="dataIn.type === getPropertyType('PROPERTY_TYPE_CLASS')"
        ...
        <el-table-column label="属性代码" prop="edmpCode" width="90px" align="center" fixed>
        </el-table-column>
