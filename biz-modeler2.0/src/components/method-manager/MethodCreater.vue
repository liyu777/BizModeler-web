    ...
    <el-form :model="formData"  ref="form">
      <el-tabs type="border-card">
        <el-tab-pane label="基础信息">
          <el-form :model="formData.info" :inline="true" :rules="rules" ref="formInfo">
          <el-form-item  label="方法分类" prop="edmmType" label-width="75px">
            <el-input v-model="formData.info.edmmTypeName"  size="small" @focus="openTree" :disabled="!isEdit"
                      placeholder="请选择方法分类"  icon="plus" @click="openTree" readonly style="width: 190px"></el-input>
          </el-form-item>
...
<!--            <el-form-item label="状态：">
            ...
            <el-form-item label="程序员" prop="edmmProgrammer" label-width="75px">
              <el-input   v-model="formData.info.edmmProgrammer"  size="small" :disabled="!isEdit"></el-input>
            </el-form-item>
            ...
            <div style="display: block">
            <el-form-item label="方法描述" prop="edmmDesc" size="small" label-width="75px">
              <el-input
                        type="textarea"
                        :disabled="!isEdit"
                        :rows="2"
